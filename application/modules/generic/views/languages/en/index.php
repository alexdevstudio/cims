...
<html lang="en">
    ...
    <body class="trd-home-template trd-homepage-one">
                  ...
                  <div class="container">
                    <div class="row">
                      ...
                      <div class="navbar-header">
                          ...
                          <!-- Logo -->
                          <a class="navbar-brand" href="index.html"><img class="logo" src="<?= base_url() ?>assets/frontend/images/logo-header.png" alt="TRADE"></a>
                      </div>
                      <!-- Navbar Toggle End -->
            ...
            <div class="slider-pro trd-hero-slider" id="trd-hero-slider">
                <div class="sp-slides">
                    ...
                    <div class="sp-slide trd-main-slides">
                        ...
                        <img class="sp-image" src="<?= base_url() ?>assets/frontend/images/slider-img-1.jpg" alt="Slider Image"/>
                        ...
                        <div class="sp-layer trd-slider-img trd-mac-img" data-position="bottomCenter" data-vertical="-25" data-horizontal="125" data-show-delay="500" data-hide-delay="200" data-show-transition="left" data-hide-transition="right">
                            <img src="<?= base_url() ?>assets/frontend/images/shape.png" alt="Triangle Shape">
                        </div>
                    ...
                    <div class="sp-slide trd-main-slides">
                        <!-- <div class="az-dark-color-overlay"></div> -->
                        <img class="sp-image" src="<?= base_url() ?>assets/frontend/images/slider-img-2.jpg" alt="Slider Image"/>
                ...
                <div class="row">
                    ...
                    <div class="trd-key-to-success">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12 trd-imagebox-with-text-wrapper appear fadeIn" data-wow-duration="1s" data-wow-delay=".3s">
                            <div class="trd-imagebox-with-text">
                                <div class="trd-image-wrapper">
                                    <img src="<?= base_url() ?>assets/frontend/images/imgbox-img-1.jpg" alt="Success Image">
                                </div>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12 trd-imagebox-with-text-wrapper appear fadeIn" data-wow-duration="1s" data-wow-delay=".5s">
                            <div class="trd-imagebox-with-text">
                                <div class="trd-image-wrapper">
                                    <img src="<?= base_url() ?>assets/frontend/images/category-img-3.jpg" alt="Success Image">
                                </div>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12 trd-imagebox-with-text-wrapper appear fadeIn" data-wow-duration="1s" data-wow-delay=".7s">
                            <div class="trd-imagebox-with-text">
                                <div class="trd-image-wrapper">
                                    <img src="<?= base_url() ?>assets/frontend/images/imgbox-img-3.jpg" alt="Success Image">
                                </div>
        ...
        <section class="trd-custom-section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="trd-custom-sec-img-wrapper">
                        <img src="<?= base_url() ?>assets/frontend/images/custom-img.jpg" alt="We are Expert">
                    </div>
                </div>
            </div>
            ...
            <div class="trd-partners-logo-section">
                <div class="container">
                    <div class="row">
                        <ul>
                            <li><img src="<?= base_url() ?>assets/frontend/images/client-logo-1.png" alt="Clients Logo"></li>
                            <li><img src="<?= base_url() ?>assets/frontend/images/client-logo-2.png" alt="Clients Logo"></li>
                            <li><img src="<?= base_url() ?>assets/frontend/images/client-logo-3.png" alt="Clients Logo"></li>
                            <li><img src="<?= base_url() ?>assets/frontend/images/client-logo-4.png" alt="Clients Logo"></li>
                            <li><img src="<?= base_url() ?>assets/frontend/images/client-logo-1.png" alt="Clients Logo"></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="trd-image-with-overlay">
                        <img src="<?= base_url() ?>assets/frontend/images/category-img-1.jpg" alt="Corporate Ledership">
                    ...
                    <!-- Imagebox -->
                    <div class="trd-image-with-overlay">
                        <img src="<?= base_url() ?>assets/frontend/images/category-img-2.jpg" alt="Market Analysis">
                        <a href="#" class="trd-img-overlay">
                    ...
                    <!-- Imagebox -->
                    <div class="trd-image-with-overlay">
                        <img src="<?= base_url() ?>assets/frontend/images/category-img-3.jpg" alt="Financial Planning">
                        <a href="#" class="trd-img-overlay">
                ...
                <div class="row">
                    ...
                    <div id="trd-testimonial" class="trd-testimonial">
                        ...
                        <div class="trd-testimonial-slides">
                            ...
                            <div class="trd-satisfied-user-info">
                                <div class="trd-user-img-wrapper">
                                    <img src="<?= base_url() ?>assets/frontend/images/clients-img-1.png" alt="Clients Image">
                                </div>
                                <h3>Adrian</h3>
                        ...
                        <div class="trd-testimonial-slides">
                            ...
                            <div class="trd-satisfied-user-info">
                                <div class="trd-user-img-wrapper">
                                    <img src="<?= base_url() ?>assets/frontend/images/clients-img-2.png" alt="Clients Image">
                                </div>
                                <h3>David Paul</h3>
                        ...
                        <div class="trd-testimonial-slides">
                            ...
                            <div class="trd-satisfied-user-info">
                                <div class="trd-user-img-wrapper">
                                    <img src="<?= base_url() ?>assets/frontend/images/clients-img-3.png" alt="Clients Image">
                                </div>
                                <h3>Natasha</h3>
                        ...
                        <div class="trd-testimonial-slides">
                            ...
                            <div class="trd-satisfied-user-info">
                                <div class="trd-user-img-wrapper">
                                    <img src="<?= base_url() ?>assets/frontend/images/clients-img-4.png" alt="Clients Image">
                                </div>
                                <h3>Anida Neo</h3>
                        ...
                        <div class="trd-testimonial-slides">
                            ...
                            <div class="trd-satisfied-user-info">
                                <div class="trd-user-img-wrapper">
                                    <img src="<?= base_url() ?>assets/frontend/images/clients-img-5.png" alt="Clients Image">
                                </div>
                                <h3>Steve Smith</h3>
        ...
        <!-- Bar Chart -->
        <script src="<?= base_url() ?>assets/frontend/js/barChart.js"></script>
