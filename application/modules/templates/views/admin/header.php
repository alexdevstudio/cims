...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?= base_url('admin') ?>" class="logo">
      ...
      <span class="logo-mini"><img src="http://demo.alexdev.gr/cms/assets/img/logo_light_180_75.png" alt=""></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="http://demo.alexdev.gr/cms/assets/img/logo_light_180_75.png" alt=""></span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview <?= ($this->uri->segment(2)=='page') ? 'menu-open' : '' ?>">
          <a href="#">
            <i class="fa fa fa-files-o"></i> <span>Pages</span>
          ...
          <ul class="treeview-menu" style="display:<?= ($this->uri->segment(2)=='page') ? 'block' : 'none' ?>">
            ...
            <li class="<?= ($this->uri->segment(2)=='page' && $this->uri->segment(5)=='add') ? 'active' : '' ?>"><a href="<?= base_url('admin/page/index/new/add'); ?>"><i class="fa fa-plus"></i> New Page</a></li>
          </ul>
        </li>
        <li class="<?= ($this->uri->segment(2)=='media') ? 'active' : '' ?>"><a href="<?= base_url('admin/media'); ?>"><i class="fa fa-image"></i> Media</a></li>
        <li class="treeview <?= ($this->uri->segment(2)=='user') ? 'menu-open' : '' ?>">
          <a href="#">
          ...
          <ul class="treeview-menu" style="display:<?= ($this->uri->segment(2)=='user') ? 'block' : 'none' ?>">
            <li class="<?= ($this->uri->segment(2)=='user' && $this->uri->segment(5)=='') ? 'active' : '' ?>"><a href="<?= base_url('admin/user'); ?>"><i class="fa fa-users"></i> All Users</a></li>
            <li class="<?= ($this->uri->segment(2)=='user' && $this->uri->segment(5)=='add') ? 'active' : '' ?>"><a href="<?= base_url('admin/user/create_user'); ?>"><i class="fa fa-plus"></i> New User</a></li>
          </ul>
        </li>
