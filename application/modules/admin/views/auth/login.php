...
<div class="login-box">
  <div class="login-logo">
    <a href="../assets/admin/index2.html">
      <img src="<?= base_url('assets/img/logo_dark_180_75.png') ?>" alt="">
    </a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="login" method="post">
      ...
      <div class="text-red text-center"><?php echo $message;?></div>
      <div class="row">
        <!-- <div class="col-xs-8">
        ...
        <!-- /.col -->
        <div class="col-xs-12">
          <button type="submit" class="pull-right btn btn-primary  btn-flat">Sign In</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
