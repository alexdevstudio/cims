...
/*
| -------------------------------------------------------------------------
| Custom config added by Alex.
| -------------------------------------------------------------------------
|
*/
$config['allow_user_registration'] = TRUE; //Default FALSE. Only admins can register new users
 ...
 */
$config['site_title']                 = "YourDomain.com";       // Site Title, example.com
...
$config['email_config'] = array(
	'smtp_host' => 'mail.alexdev.gr',
	'smtp_port' => 587,
	'smtp_crypto' => 'tls',
	'smtp_user' => 'user@alexdev.gr', // change it to yours
	'smtp_pass' => 's@323Dsrrw', // change it to yours
	'smtp_timeout'=>20,
	'mailtype' => 'HTML',
	'charset' => 'UTF-8',
	'wordwrap' => TRUE
